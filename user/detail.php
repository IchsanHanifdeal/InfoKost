...
$query = "SELECT k.*, km.jumlah_kamar AS jumlah_kamar_kamar, km.panjang_kamar, km.lebar_kamar, km.tipe_kamar, km.biaya_fasilitas
FROM kost k
JOIN kamar km ON k.id_kost = km.id_kost
...
if ($result->num_rows > 0) {
    ...
    $jumlahKamar = $row['jumlah_kamar_kamar'];
    $fasilitasKost = $row['fasilitas_kost'];
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex  flex-column">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="badge rounded-pill bg-white text-dark text-wrap" style="font-size: 1rem;"><?php if ($jenisKost == 'erempuan') {
                                                                                                                                            echo 'Perempuan';
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="submit-booking">
                                                <a href="pembayaran1.php?id_kost=<?php echo $row['id_kost']; ?>" class="btn btn-primary">Booking</a>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
