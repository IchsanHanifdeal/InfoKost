...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/Booking/index.php" class="nav-link active">List User</a>
                </li>
            </ul>
        </nav>
        <!-- /.navbar -->
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped projects">
                                    ...
                                    <tbody>
                                        <?php
                                        // Menampilkan data pengguna dalam baris (row)
                                        $counter = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['Password'] ?></td>
                                                <td><?= $row['role'] ?></td>
                                                <td class="project-state"><span class="badge badge-success">Aktiv</span></td>
                                                <td class="project-actions text-right">
                                                    <a class="btn btn-primary btn-sm" href="profilAllUser.php?id=<?= $row['id'] ?>">
                                                        <i class="fas fa fa-eye"></i>
                                                        View
                                                    </a>
                                                    <a class="btn btn-danger btn-sm" href="#" onclick="konfirmasiHapus(<?php echo $row['id'] . ', \'' . $row['NamaLengkap'] . '\''; ?>);">
    ...
    <script>
        function konfirmasiHapus(id, namaPengguna) {
            var konfirmasi = confirm("Apakah Anda yakin ingin menghapus pengguna " + namaPengguna + "?");
            if (konfirmasi === true) {
                window.location.href = "hapusUser.php?id=" + encodeURIComponent(id);
            }
            return false;
        }
    </script>
