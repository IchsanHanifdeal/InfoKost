                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                <button class="btn btn-primary" href="kos.php" onclick="window.history.back()">Kembali</button>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                                ...
                                                $tanggalTagih = $_POST['tanggal_tagih'];
                        ...
                        WHERE id_kost = '$idKost'";
                                            ...
                                            <form method="POST" action="" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your name" value="<?php echo $namaKost; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputAddress">Boarding Address</label>
                                                    <textarea class="form-control" id="exampleInputAddress" rows="3" placeholder="Enter your address" <?php echo $alamat; ?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName">Provinsi</label>
                                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your name house" value="<?php echo $provinsi; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName">Kabupaten/Kota</label>
                                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your name house" value="<?php echo $kota; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName">Kecamatan</label>
                                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your name house" value="<?php echo $kecamatan; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName">Kelurahan</label>
                                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your name house" value="<?php echo $kelurahan; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputAddress">Deskripsi Kos (optional)</label>
                                                    <textarea class="form-control" id="exampleInputAddress" rows="3" placeholder="Enter your address"><?php echo $deskripsi; ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPhone">Nomor Telepon</label>
                                                    <input type="text" class="form-control" id="exampleInputPhone" placeholder="Enter your phone number" oninput="validateNumber(event)" require value="<?php echo $kontak; ?>">
                                                    <hr style="border-color: white;">
                                                </div>
                                                <div class="form-group text-center">
                                                    <h5>Detail Kos</h5>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="billing-date">Ditagih Setiap Tanggal</label>
                                                <input type="date" class="form-control" id="billing-date" name="tanggal_tagih" value="<?php echo $tanggalTagih; ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="account-number" name="account-number" placeholder="Masukkan nomor rekening">
                                                <hr style="border-color: white;">
                                            </div>
                                            <div class="form-group text-center">
                                                <h5>Foto Bangunan</h5>
